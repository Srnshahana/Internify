...
export default function LightThemeLandingPage({ 
  onOpenExplore, 
  onOpenResources, 
  onOpenLogin,
  onMentorClick,
      ...
      {/* <section className="light-theme-career-guidance-section">
        <div className="light-theme-testimonials-container">
          <div className="light-theme-testimonials-left">
            ...
            <h2 className="light-theme-testimonials-title">Not Sure What to Do Next?</h2>
            <p className="light-theme-testimonials-subtext">Get personalized career advice from experienced career guiders and life advisors.</p>
            <div className="light-theme-testimonials-navigation">
              <button 
                className="light-theme-testimonials-nav-btn"
          ...
          <div className="light-theme-testimonials-right" ref={careerGuidanceRightRef}>
            <div className="light-theme-testimonials-stack-container" ref={careerGuidanceTrackRef}>
              {careerGuidanceTestimonials.map((testimonial, index) => {
                ...
                return (
                  <div 
                    key={testimonial.id} 
                    className={`light-theme-testimonial-card light-theme-testimonial-card-${testimonial.bgColor} ${
                      isActive ? 'light-theme-testimonial-active' : 
                      isPrevious ? 'light-theme-testimonial-stacked' : 
                      'light-theme-testimonial-upcoming'
                    }`}
                    data-distance={distance}
                    data-index={index}
                  >
                    <div className="light-theme-testimonial-header">
                      <img 
                        src={testimonial.mentorImage} 
                        alt={testimonial.mentorName}
                        className="light-theme-testimonial-mentor-image"
                      />
                      <div className="light-theme-testimonial-mentor-info">
                        <h3 className="light-theme-testimonial-mentor-name">{testimonial.mentorName}</h3>
                        <p className="light-theme-testimonial-mentor-role">{testimonial.mentorRole}</p>
                      </div>
                    </div>
                    <p className="light-theme-testimonial-quote">{testimonial.quote}</p>
                    <div className="light-theme-testimonial-footer">
                      <span className="light-theme-testimonial-student-name">{testimonial.studentName}</span>
                      <span className="light-theme-testimonial-student-rating">
